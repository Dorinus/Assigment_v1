package external.TemperatureSimul;
...
public class Thermometer implements Runnable
{
  ...
  public Thermometer(String id, double t, int d, double outsTemp, Radiator radiator)
  {
    this.id = id;
    this.t = t;
    this.d = d;
  ...
  @Override public void run()
  {
    ...
    while (true)
    {
      ...
      t = temperature(t, radiator.getPower(), d, t0, 6);
      System.out.println("Temperature for " + id + " heater is " + t + ".");
    }
